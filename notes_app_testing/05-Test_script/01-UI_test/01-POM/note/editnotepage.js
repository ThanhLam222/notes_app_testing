...
// POM for Edit note page
// Encapsulates locators and actions for the Edit note page
export class EditNotePage extends MainLayout{
...
// Getters/ Methods to get locators
    ...
    // Returns heading of Edit note page
    get pageTitle() { return this._page.getByRole('heading', { name: 'Edit Note' }); } 

    // Returns all fields inside the Edit note form
    ...
    //Go to URL of page
    async goto(noteID) { await this._page.goto(`/notes/edit/${noteID}`); }
